...
//define("CPANEL_PATH", "/application/modules/admin/views/");
/*
 * --------------------------------------------------------------------
 ...
 * And away we go...
 */
define('DIRPATH', $root.'\application\\');
define('ROOTPATH', $root);
require_once BASEPATH . 'core/CodeIgniter.php';

//define("CPANEL_PATH", "/application/modules/cpanel/views/");
