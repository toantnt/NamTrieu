...
class Code_Pagination {
    
    public $array;
    public $curPage;
    public $perPage;
    
    public $_showFirstAndLast;
     ...
     * Constructor
     * 
     * @param array $data   Array of results to be paginated
     ...
     * @access public  
     */
    public function __construct($data = array(), $curPage = null, $perPage = null) {
        $this->array = $data;
        ...
        if (($this->pages) > 1) {
            ...
            if ($this->page != 1) {
                if ($this->_showFirstAndLast) {
                    $plinks[] = '<li><a href="?page=1' . $queryUrl . '">&laquo; First </a> </li>';
                }
            ...
            if ($this->page < $this->pages) {
                $slinks[] = '<li> <a href="?page=' . ($this->page + 1) . $queryUrl . '"> Next </a> </li>';
                if ($this->_showFirstAndLast) {
                    $slinks[] = '<li> <a href="?page=' . ($this->pages) . $queryUrl . '"> Last &raquo; </a> </li>';
                }
            }
