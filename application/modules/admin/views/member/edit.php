            ...
            <div class="box-body">
                <form id="formEditCand" method="post" name="formMember" class="form-horizontal" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input class="form-control" type="text" id="member_name" name="member_name" value="<?php echo $member->member_name?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Email</label>
                        <div class="col-md-7">
                            <input class="form-control" type="email" id="member_email" name="member_email" value="<?php echo $member->member_email?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Số điện thoại</label>
                        <div class="col-md-7">
                            <input class="form-control" type="text" id="member_phone" name="member_phone" value="<?php echo $member->member_phone?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Tên đăng nhập</label>
                        <div class="col-md-7">
                            <input class="form-control" type="text" id="member_username" name="member_username" value="<?php echo $member->member_username?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" class="checkbox" name="member_status" value="1" <?php echo ($member->member_status == 1 ? 'checked="checked"' : '') ?> />
                                    Kích hoạt
                                </label>
                            </div>
                        </div>
