            ...
            <div class="box-body">
                ...
                <form id="formAddTest" method="post" class="form-horizontal" accept-charset="utf-8">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input class="form-control" type="text" id="testominal_name" name="testominal_name" value="<?= set_value('testominal_name') ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Vị trí/Chức vụ</label>
                        <div class="col-md-7">
                            <input class="form-control" type="text" id="testominal_position" name="testominal_position" value="<?= set_value('testominal_position') ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Nội dung</label>
                        <div class="col-md-7">
                            <input class="form-control" type="text" id="testominal_content" name="testominal_content" value="<?= set_value('testominal_content') ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="input-group">
                                <input type="text" name="testominal_image" class="form-control" id="ImageUrl" />
...
$(document).ready(function() {
    ...
    $("#formAddTest").validate({
        ...
        messages: { 
            testominal_name : {
                required : "testominal_name không được để trống",
            },
            testominal_position : {
                required : "Email không được để trống",
            },
            testominal_content : {
                required : "testominal_content không được để trống",
            },
        },
