      			...
      			<ul class="sidebar-menu" data-widget="tree">
					...
					<li <?php echo ($active=='appearance' ? 'class="active"' : '') ?>>
						<a href="<?php echo site_url('admin/appearance') ?>">
							<i class="fa fa-sliders"></i> <span>Tổng quan</span>
							<span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
                    ...
                    <li class="treeview<?php echo ($active=='media' ? ' active menu-open' : '') ?>">
                        ...
                        <ul class="treeview-menu">
                            <li <?php echo ($sub_active=='menu' ? 'class="active"' : '') ?>>
                                <a href="<?php echo site_url('admin/navigation') ?>"><i class="fa fa-circle-o"></i> Menu</a>
                            </li>
                            <li <?php echo ($sub_active=='group_menu' ? 'class="active"' : '') ?>><a href="<?php echo site_url('admin/group_menu') ?>"><i class="fa fa-circle-o"></i> Nhóm menu</a></li>
                            <li <?php echo ($sub_active=='slide' ? 'class="active"' : '') ?>><a href="<?php echo site_url('admin/slide') ?>"><i class="fa fa-circle-o"></i> Slider ảnh</a></li>
                            <li <?php echo ($sub_active=='testominal' ? 'class="active"' : '') ?>><a href="<?php echo site_url('admin/testominal') ?>"><i class="fa fa-circle-o"></i> Testominal</a></li>
                    ...
                    <li class="treeview<?php echo ($active=='pages' ? ' active menu-open' : '') ?>">
                        <a href="<?php echo site_url('admin/page') ?>">
                            <i class="fa fa-file-text" aria-hidden="true"></i> <span>Quản lý Tập tin</span>
                            <span class="pull-right-container">
				              	<i class="fa fa-angle-left pull-right"></i>
				            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li <?php echo ($sub_active=='page' ? 'class="active"' : '') ?>>
                                <a href="<?php echo site_url('admin/page') ?>"><i class="fa fa-circle-o"></i> Tất cả</a>
                            </li>
                            <li><a href="<?php echo site_url('admin/page/add') ?>"><i class="fa fa-circle-o"></i> Ứng viên tải lên</a></li>
                    ...
                    <li class="treeview<?php echo ($active=='member' ? ' active menu-open' : '') ?>">
						...
						<ul class="treeview-menu">
                            <li <?php echo ($sub_active=='company' ? 'class="active"' : '') ?>><a href="<?php echo site_url('admin/member') ?>"><i class="fa fa-circle-o"></i> Quản lý thành viên</a></li>
							<li <?php echo ($sub_active=='company' ? 'class="active"' : '') ?>><a href="<?php echo site_url('admin/company') ?>"><i class="fa fa-circle-o"></i> Nhà tuyển dụng</a></li>
							<li <?php echo ($sub_active=='candidate' ? 'class="active"' : '') ?>><a href="<?php echo site_url('admin/candidate') ?>"><i class="fa fa-circle-o"></i> Ứng viên</a></li></a></li>
			          	</ul>
					</li>
                   	
					<li class="treeview<?php echo ($active=='news' ? ' active menu-open' : '') ?>">
						<a href="<?php echo site_url('admin/post') ?>">
							<i class="fa fa-newspaper-o"></i> <span>Tin &amp; Bài viết</span>
							<span class="pull-right-container">
				              	<i class="fa fa-angle-left pull-right"></i>
				            </span>
						</a>
						<ul class="treeview-menu">
							<li><a href="<?php echo site_url('admin/post') ?>"><i class="fa fa-circle-o"></i> Danh sách tin</a></li>
							<li><a href="<?php echo site_url('admin/post/add') ?>"><i class="fa fa-circle-o"></i> Tạo mới</a></li>
			            	<li><a href="<?php echo site_url('admin/category') ?>"><i class="fa fa-circle-o"></i> Danh mục</a></li>
			          	</ul>
					</li>

                    <li class="treeview<?php echo ($active=='pages' ? ' active menu-open' : '') ?>">
                        <a href="<?php echo site_url('admin/page') ?>">
                            <i class="fa fa-file-text" aria-hidden="true"></i> <span>Trang tĩnh</span>
                            <span class="pull-right-container">
				              	<i class="fa fa-angle-left pull-right"></i>
				            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li <?php echo ($sub_active=='page' ? 'class="active"' : '') ?>>
                                <a href="<?php echo site_url('admin/page') ?>"><i class="fa fa-circle-o"></i> Danh sách trang</a>
                            </li>
                            <li><a href="<?php echo site_url('admin/page/add') ?>"><i class="fa fa-circle-o"></i> Tạo mới</a></li>
					...
					<li class="treeview<?php echo ($active=='user' ? ' active menu-open' : '') ?>">
						...
						<ul class="treeview-menu">
							<li <?php echo ($sub_active=='user' ? 'class="active"' : '') ?>><a href="<?php echo site_url('admin/user') ?>"><i class="fa fa-circle-o"></i> Danh sách quản trị viên</a></li>
							<li <?php echo ($sub_active=='add_user' ? 'class="active"' : '') ?>><a href="<?php echo site_url('admin/user/edit') ?>"><i class="fa fa-circle-o"></i> Tạo mới</a></li></a></li>
			          	</ul>
					</li>
